!(function (e, t) {
      ...
      return (
        ...
        (e._getRootElement = function (e) {
          var t = m.getSelectorFromElement(e),
            n = !1;
          return (
            t && (n = document.querySelector(t)), n || f(e).closest('.alert')[0]
          );
        }),
  ...
  f(document).on(
    ...
    (f.fn[s].noConflict = function () {
      return (f.fn[s] = c), h._jQueryInterface;
    });
  var p = 'button',
    g = 'bs.button',
    v = '.' + g,
    ...
    k = (function () {
      ...
      return (
        ...
        (n._jQueryInterface = function (t) {
          return this.each(function () {
            var e = f(this).data(g);
            e || ((e = new n(this)), f(this).data(g, e)),
              'toggle' === t && e[t]();
          });
        }),
        r(n, null, [
  ...
  f(document)
    .on(E.CLICK_DATA_API, w, function (e) {
      var t = e.target;
      if (
        (f(t).hasClass('btn') || (t = f(t).closest(T)[0]),
    ...
    H = (function () {
      ...
      return (
        ...
        (e._getConfig = function (e) {
          return (e = l({}, D, {}, e)), m.typeCheckConfig(S, e, O), e;
        }),
        ...
        (e._addEventListeners = function () {
          ...
          this._config.keyboard &&
            f(this._element).on(M.KEYDOWN, function (e) {
              return t._keydown(e);
            }),
        ...
        (e._addTouchEventListeners = function () {
          ...
          if (this._touchSupported) {
            var t = function (e) {
                n._pointerEvent && q[e.originalEvent.pointerType.toUpperCase()]
            ...
            f(this._element.querySelectorAll('.carousel-item img')).on(
              ...
              this._pointerEvent
                ? (f(this._element).on(M.POINTERDOWN, function (e) {
                    return t(e);
                  }),
                ...
                : (f(this._element).on(M.TOUCHSTART, function (e) {
                    return t(e);
                  }),
        ...
        (o._jQueryInterface = function (i) {
          return this.each(function () {
            ...
            if (
              (e || ((e = new o(this, t)), f(this).data(A, e)),
              'number' == typeof i)
            )
              e.to(i);
  ...
  f(document).on(
    ...
    (f.fn[S].Constructor = H),
    (f.fn[S].noConflict = function () {
      return (f.fn[S] = $), H._jQueryInterface;
    });
  var R = 'collapse',
    z = 'bs.collapse',
    F = '.' + z,
        ...
        (e.show = function () {
          ...
          if (
            ...
            if ((f(this._element).trigger(i), !i.isDefaultPrevented())) {
              e &&
                (a._jQueryInterface.call(f(e).not(this._selector), 'hide'),
                t || f(e).data(z, null));
                ...
                for (var s = 0; s < i; s++) {
                  ...
                  null !== r &&
                    (f([].slice.call(document.querySelectorAll(r))).hasClass(
                      ...
                      f(o).addClass(G).attr('aria-expanded', !1));
                }
  ...
  f(document).on(V.CLICK_DATA_API, Z, function (e) {
    ...
    (f.fn[R].noConflict = function () {
      return (f.fn[R] = B), X._jQueryInterface;
    });
  var J = 'dropdown',
    ee = 'bs.dropdown',
    te = '.' + ee,
      ...
      return (
        ...
        (e.show = function (e) {
          if (
            ...
            !(
              ...
              f(this._element).hasClass(re) ||
              f(this._menu).hasClass(ae)
            ))
          ) {
        ...
        (e._getPlacement = function () {
          ...
          return (
            e.hasClass('dropup')
              ? ((t = 'top-start'),
                f(this._menu).hasClass(le) && (t = 'top-end'))
              : e.hasClass('dropright')
              ? (t = 'right-start')
              : e.hasClass('dropleft')
              ? (t = 'left-start')
              : f(this._menu).hasClass(le) && (t = 'bottom-end'),
            t
          );
        }),
  ...
  f(document)
    ...
    (f.fn[J].noConflict = function () {
      return (f.fn[J] = ie), pe._jQueryInterface;
    });
  var fe = 'modal',
    me = 'bs.modal',
    ge = '.' + me,
      ...
      return (
        ...
        (e.show = function (e) {
          ...
          if (!this._isShown && !this._isTransitioning) {
            ...
            var n = f.Event(be.SHOW, { relatedTarget: e });
        ...
        (e._getConfig = function (e) {
          return (e = l({}, ye, {}, e)), m.typeCheckConfig(fe, e, _e), e;
        }),
        ...
        (e._showElement = function (e) {
          ...
          var o = f.Event(be.SHOWN, { relatedTarget: e });
          if (n) {
        ...
        (e._setEscapeEvent = function () {
          ...
          this._isShown && this._config.keyboard
            ? f(this._element).on(be.KEYDOWN_DISMISS, function (e) {
        ...
        (e._setResizeEvent = function () {
          var t = this;
          this._isShown
            ? f(window).on(be.RESIZE, function (e) {
          ...
          if (this._isBodyOverflowing) {
            ...
            f(e).each(function (e, t) {
              ...
              f(t)
                ...
                .css('padding-right', parseFloat(i) + s._scrollbarWidth + 'px');
            }),
        ...
        (e._resetScrollbar = function () {
          ...
          f(t).each(function (e, t) {
            ...
            void 0 !== n &&
              f(t).css('margin-right', n).removeData('margin-right');
          });
        ...
        (s._jQueryInterface = function (n, i) {
          return this.each(function () {
            ...
            if (
              (e || ((e = new s(this, t)), f(this).data(me, e)),
              'string' == typeof n)
            ) {
              if (void 0 === e[n])
                throw new TypeError('No method named "' + n + '"');
  ...
  f(document).on(be.CLICK_DATA_API, '[data-toggle="modal"]', function (e) {
    ...
    (f.fn[fe].noConflict = function () {
      return (f.fn[fe] = ve), Ae._jQueryInterface;
    });
  var xe = [
      'background',
      'cite',
          ...
          i.forEach(function (e) {
            !(function (e, t) {
              ...
              if (-1 !== t.indexOf(n))
                return (
                  -1 === xe.indexOf(n) ||
                  Boolean(e.nodeValue.match(Ie) || e.nodeValue.match($e))
                );
              for (
      ...
      return (
        ...
        (e._enter = function (e, t) {
          ...
          (t = t || f(e.currentTarget).data(n)) ||
            ...
            f(t.getTipElement()).hasClass(We) || t._hoverState === Fe
              ? (t._hoverState = Fe)
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              ...
              (e || ((e = new i(this, t)), f(this).data(Pe, e)),
              'string' == typeof n)
            ) {
              if (void 0 === e[n])
                throw new TypeError('No method named "' + n + '"');
  ...
  (f.fn[Oe] = Qe._jQueryInterface),
    ...
    (f.fn[Oe].noConflict = function () {
      return (f.fn[Oe] = Me), Qe._jQueryInterface;
    });
  var Ye = 'popover',
    Ge = 'bs.popover',
    Ze = '.' + Ge,
    ...
    nt = l({}, Qe.DefaultType, { content: '(string|element|function)' }),
    it = {
      HIDE: 'hide' + Ze,
      HIDDEN: 'hidden' + Ze,
      SHOW: 'show' + Ze,
      ...
      return (
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (e || !/dispose|hide/.test(n)) &&
              (e || ((e = new i(this, t)), f(this).data(Ge, e)),
              'string' == typeof n)
            ) {
              if (void 0 === e[n])
                throw new TypeError('No method named "' + n + '"');
  ...
  (f.fn[Ye] = st._jQueryInterface),
    ...
    (f.fn[Ye].noConflict = function () {
      return (f.fn[Ye] = Xe), st._jQueryInterface;
    });
  var ot = 'scrollspy',
    rt = 'bs.scrollspy',
    at = '.' + rt,
    ...
    vt = (function () {
      ...
      return (
            ...
            [].slice
              ...
              .map(function (e) {
                ...
                if ((n && (t = document.querySelector(n)), t)) {
                  ...
                  if (i.width || i.height) return [f(t)[s]().top + o, n];
                }
                return null;
              })
              .filter(function (e) {
        ...
        (e._getConfig = function (e) {
          if (
            'string' !=
            typeof (e = l({}, ct, {}, 'object' == typeof e && e ? e : {}))
              .target
          ) {
            var t = f(e.target).attr('id');
            t || ((t = m.getUID(ot)), f(e.target).attr('id', t)),
              (e.target = '#' + t);
          }
          return m.typeCheckConfig(ot, e, ut), e;
        }),
        ...
        (e._activate = function (t) {
          ...
          n.hasClass('dropdown-item')
            ? (n.closest('.dropdown').find('.dropdown-toggle').addClass(ht),
              n.addClass(ht))
            : (n.addClass(ht),
              n
                .parents(pt)
            ...
            f(this._scrollElement).trigger(dt.ACTIVATE, { relatedTarget: t });
        }),
        (e._clear = function () {
          [].slice
            .call(document.querySelectorAll(this._selector))
  ...
  f(window).on(dt.LOAD_DATA_API, function () {
    ...
    (f.fn[ot].noConflict = function () {
      return (f.fn[ot] = lt), vt._jQueryInterface;
    });
  var yt = 'bs.tab',
    _t = '.' + yt,
    bt = f.fn.tab,
      ...
      return (
        (e.show = function () {
          ...
          if (
            ...
            var r = f.Event(wt.HIDE, { relatedTarget: this._element }),
              a = f.Event(wt.SHOW, { relatedTarget: i });
            if (
              (i && f(i).trigger(r),
              ...
              var l = function () {
                var e = f.Event(wt.HIDDEN, { relatedTarget: n._element }),
                  t = f.Event(wt.SHOWN, { relatedTarget: i });
        ...
        (e.dispose = function () {
          f.removeData(this._element, yt), (this._element = null);
        }),
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            var e = f(this),
              t = e.data(yt);
            if (
              (t || ((t = new i(this)), e.data(yt, t)), 'string' == typeof n)
            ) {
              if (void 0 === t[n])
                throw new TypeError('No method named "' + n + '"');
              t[n]();
  ...
  f(document).on(
    ...
    function (e) {
      e.preventDefault(), kt._jQueryInterface.call(f(this), 'show');
    }
  ),
    (f.fn.tab = kt._jQueryInterface),
    (f.fn.tab.Constructor = kt),
    (f.fn.tab.noConflict = function () {
      return (f.fn.tab = bt), kt._jQueryInterface;
    });
  var St = 'toast',
    At = 'bs.toast',
    xt = '.' + At,
    ...
    Mt = (function () {
      ...
      return (
        ...
        (e._close = function () {
          function e() {
            t._element.classList.add('hide'), f(t._element).trigger($t.HIDDEN);
          }
          var t = this;
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (t ||
                ((t = new i(this, 'object' == typeof n && n)), e.data(At, t)),
              'string' == typeof n)
            ) {
              if (void 0 === t[n])
                throw new TypeError('No method named "' + n + '"');
  ...
  (f.fn[St] = Mt._jQueryInterface),
    ...
    (f.fn[St].noConflict = function () {
      return (f.fn[St] = It), Mt._jQueryInterface;
    }),
    (e.Alert = h),
    (e.Button = k),
    (e.Carousel = H),
  ...
  (function (n) {
      ...
      var i = {
        ...
        setPosition: function () {
          var e = $('.core-nav-list'),
            t = e.outerHeight() / 2;
          920 < $(window).width()
            ? (e.css('margin-top', -1 * t),
              e.css('top', 0.5 * $(window).height()))
            : (e.css('margin-top', 0), e.css('top', 0));
        },
      };
      e.exports = i;
    },
      ...
      var i = {
        ...
        layout: function (e) {
          var t = $(window).width(),
            ...
            i = n.height() / 2;
          if (920 < t) {
            if ((n.css('margin-top', '-' + i + 'px'), e.menuFullWidth)) {
              var s = $('.core-nav-list > li').length,
                o = (t - $('.sidebar-toggle').width()) / s;
              $('.core-nav-list > li').css('width', o - 0.5 + 'px');
            }
          } else
            n.css('margin-top', ''), $('.core-nav-list > li').css('width', '');
        },
      };
      e.exports = i;
    },
    ...
    function (e, t, n) {
      ...
      var i = {
        init: function (t, e) {
          e.container
            ? t.wrapInner("<div class='nav-container'></div>")
            : t.wrapInner("<div class='full-container'></div>"),
            $('.core-nav').addClass('fullscreen'),
            $('.wrap-core-nav-list .menu').wrap(
              "<div class='nav-container'></div>"
            );
          var n = $('.core-nav-toggle').html();
          $('.wrap-core-nav-list > .nav-container').prepend(
            '<button class="toggle-bar core-nav-toggle">' + n + '</button>'
          ),
            $('.core-nav-toggle').on('click', function (e) {
              e.preventDefault(),
                t.toggleClass('open-fullscreen'),
                $('.core-responsive-slide').length &&
                  $('.core-responsive-slide').toggleClass('open');
            });
        },
      };
      e.exports = i;
    ...
    function (e, t, n) {
      ...
      var i = {
        init: function (e, t) {
          t.container
            ? e.wrapInner("<div class='nav-container'></div>")
            : e.wrapInner("<div class='full-container'></div>"),
        ...
        devidedMenu: function (e) {
          ...
          t.each(function () {
            for (
              ...
              e[s] = s < i ? n + 1 : n;
            for (s = 0; s < 2; s++) {
              $('.wrap-core-nav-list').append(
                $('<ul></ul>').addClass('core-nav-list')
              );
              for (var o = 0; o < e[s]; o++) {
                for (var r = 0, a = 0; a < s; a++) r += e[a];
                $('.wrap-core-nav-list')
                  .find('.core-nav-list')
                  .last()
                  .append(t[o + r]);
            ...
            $('.core-nav-list')
              .eq(1)
              .wrap('<div class="col-menu right"></div>'),
    ...
    function (e, t, n) {
      ...
      e.exports = function (i, s, e) {
        ...
        function p(e) {
          var t = o,
            n = r;
          return (o = r = void 0), (u = e), (a = i.apply(n, t));
        }
        function f(e) {
          var t = e - c;
        ...
        function m() {
          var e,
            t = _();
          if (f(t)) return g(t);
          l = setTimeout(m, ((e = s - (t - c)), h ? C(e, n - (t - u)) : e));
        }
        function g(e) {
          return (l = void 0), t && o ? p(e) : ((o = r = void 0), a);
        }
        function v() {
          var e,
            t = _(),
          ...
          if (((o = arguments), (r = this), (c = t), n)) {
            if (void 0 === l)
              return (u = e = c), (l = setTimeout(m, s)), d ? p(e) : a;
            if (h) return (l = setTimeout(m, s)), p(c);
          }
          return void 0 === l && (l = setTimeout(m, s)), a;
        }
        return (
          (s = b(s) || 0),
          y(e) &&
      ...
      var r = {
        init: function (e, t) {
          ...
          if (
            ...
            $('.core-content').length ||
              $('body').wrapInner('<div class="core-content"></div>'),
            ...
            switch (t.menuPosition) {
              case 'bottom':
                t.container
                  ? ($('.wrap-core-nav-list').wrapInner(
                      "<div class='nav-container'></div>"
                    ),
                    $(t.header).wrapInner("<div class='nav-container'></div>"))
                  : ($('.wrap-core-nav-list').wrapInner(
              ...
              case 'bottom center':
                t.container
                  ...
                  : ($('.wrap-core-nav-list').wrapInner(
                      "<div class='full-container center'></div>"
                    ),
                    $(t.header).wrapInner(
                      "<div class='full-container center'></div>"
                    ));
              ...
              case 'bottom right':
                t.container
                  ? ($('.wrap-core-nav-list').wrapInner(
                      "<div class='nav-container right'></div>"
                    ),
                    $(t.header).wrapInner("<div class='nav-container'></div>"))
                  : ($('.wrap-core-nav-list').wrapInner(
                      "<div class='full-container right'></div>"
                    ),
                    $(t.header).wrapInner(
                      "<div class='full-container'></div>"
                    ));
          ...
          t.responsideSlide &&
            $('.core-content').addClass('core-responsive-slide'),
            n.attributesIcon(t),
            n.toggleMenu(e),
            ...
            case 'sticky':
              ...
              $(window).on('resize', function () {
                ...
                $(window).on('scroll', function () {
                  $(window).scrollTop() > t
                    ? ($('.nav-core-sticky').hasClass('on-scroll') ||
                        ($.isFunction(e.onStartSticky) && e.onStartSticky()),
                      $('.nav-core-sticky').addClass('on-scroll'),
                      $('.stand-sticky').css('display', 'block'))
                    : ($('.nav-core-sticky').hasClass('on-scroll') &&
                        $.isFunction(e.onEndSticky) &&
                        e.onEndSticky(),
        ...
        topSearch: function (e) {
          ...
          t.length &&
            (t.remove(),
            $('.core-nav').prepend(
              '<div class="wrap-search-top">' + n + '</div>'
            )),
            e.container
              ? $('.wrap-search-top').wrapInner(
                  "<div class='nav-container'></div>"
                )
              : $('.wrap-search-top').wrapInner(
                  "<div class='full-container'></div>"
            ...
            $('.toggle-search-top').on('click', function (e) {
              e.preventDefault(), $('.wrap-search-top').slideToggle();
            }),
            $(window).on('resize', function () {
          ...
          if ($('.content-header').length && 'default' == e.layout)
            switch (e.menuPosition) {
              case 'bottom':
                992 < n
                  ? (e.container
                      ? $('.nav-header .nav-container').prepend(
                          "<div class='content-header'>" + t + '</div>'
                        )
                      : $('.nav-header .full-container').prepend(
                          "<div class='content-header'>" + t + '</div>'
                        ),
        ...
        fullScreenSearch: function () {
          $('.wrap-search-fullscreen').wrapInner(
            "<div class='nav-container'></div>"
          ),
            $('.toggle-search-fullscreen').on('click', function (e) {
              e.preventDefault(), $('.wrap-search-fullscreen').addClass('open');
            }),
            $(window).on('resize', function () {
              (0, i.default)(function () {
                $('.toggle-search-fullscreen').on('click', function (e) {
          ...
          if (i) {
            switch (e.menuPosition) {
              ...
              case 'bottom':
                e.container
                  ? 992 < t &&
                    ($('.core-nav .nav-container').prepend(
                      '<ul class="attributes">' + s + '</ul>'
                    ),
                    $('.nav-header .attributes').remove())
                  : 992 < t &&
                    ($('.core-nav .full-container').prepend(
                      '<ul class="attributes">' + s + '</ul>'
                    ),
                    $('.nav-header .attributes').remove());
                break;
              default:
                e.container,
                  992 < t &&
                    ($('.core-nav .wrap-core-nav-list').prepend(
                      '<ul class="attributes">' + s + '</ul>'
                    ),
                    $('.nav-header .attributes').remove());
            }
            'sidebar' == e.layout &&
              992 < t &&
              $('.core-nav').prepend('<ul class="attributes">' + s + '</ul>'),
              t < 992 &&
                ($('.nav-header').prepend(
                  '<ul class="attributes">' + s + '</ul>'
                ),
          ...
          $('.scrollspy').each(function () {
            ...
            $(i).length &&
              $(window).on('scroll', function () {
                var e;
                (e =
                  'section' == s.layout && 920 < $(window).width()
                    ? $(i).offset().top
                    : $(i).offset().top - parseInt($(i).css('padding-top'))),
                  $(window).scrollTop() > e - 1 || $(window).scrollTop() > e + 1
              ...
              $('a', this).on('click', function (e) {
                ...
                (t =
                  'section' == s.layout && 920 < $(window).width()
                    ? $(i).offset().top + 1
                    : $(i).offset().top -
                      parseInt($(i).css('padding-top')) / 2),
                  n.stop().animate({ scrollTop: t }, 500);
              });
          });
        },
    ...
    function (e, t, n) {
      ...
      (i = jQuery).fn.coreNavigation = function (e) {
        ...
        switch ((s.default.init(this, t), t.layout)) {
          case 'brand-center':
        ...
        function (e, t, n) {
          ...
          function i(e, t) {
            ...
            for (var n = Object(e), i = 1; i < arguments.length; i++) {
              ...
              if (null != s)
                for (
                  var o = Object.keys(Object(s)), r = 0, a = o.length;
                  r < a;
                  r++
                ) {
                  var l = o[r],
                  ...
                  l.addEventListener('click', function (e) {
                    ...
                    r.focus(),
                      r.addEventListener('click', function () {
                        (0, f.addClass)(r, h.modalVideoClose),
                          setTimeout(function () {
                            (0, f.remove)(r), l.focus();
                          }, p);
                      }),
                      r.addEventListener('keydown', function (e) {
                        9 === e.which &&
                          ...
                          document.activeElement === r
                            ? a.focus()
                            : (r.setAttribute('aria-label', ''), r.focus()));
                      }),
                      a.addEventListener('click', function () {
                        (0, f.triggerEvent)(r, 'click');
                      });
                  });
                });
              }
                  ...
                  },
                  {
                    ...
                    value: function (e, t, n) {
                      ...
                      return (
                        ...
                        s.modalVideoInner +
                        '">\n            <div class="' +
                        s.modalVideoIframeWrap +
                        '" style="padding-bottom:' +
                        i +
                        '">\n              <button class="' +
                        s.modalVideoCloseBtn +
  ...
  (function (e) {
    ...
    var d,
      ...
      b = function (e, t, n, i) {
        ...
        return (
          (s.className = 'mfp-' + e),
          n && (s.innerHTML = n),
          i ? t && t.appendChild(s) : ((s = u(s)), t && s.appendTo(t)),
          s
        );
      },
      w = function (e, t) {
        d.ev.triggerHandler('mfp' + e, t),
          d.st.callbacks &&
            ...
            d.st.callbacks[e] &&
              d.st.callbacks[e].apply(d, u.isArray(t) ? t : [t]));
      },
      C = function (e) {
        return (
      ...
      o = function () {
        u.magnificPopup.instance ||
          ((d = new e()).init(), (u.magnificPopup.instance = d));
      };
    (e.prototype = {
      constructor: e,
      init: function () {
      ...
      open: function (e) {
        ...
        if (!d.isOpen) {
          (d.types = []),
            ...
            d.bgOverlay ||
              ((d.bgOverlay = b('bg').on('click' + g, function () {
                d.close();
              })),
              (d.wrap = b('wrap')
                .attr('tabindex', -1)
            ...
            d.st.preloader &&
              (d.preloader = b('preloader', d.container, d.st.tLoading));
          ...
          return (
            ...
            d.bgOverlay
              .add(d.wrap)
              .prependTo(d.st.prependTo || u(document.body)),
      ...
      (u.fn.magnificPopup = function (e) {
        ...
        if ('string' == typeof e)
          if ('open' === e) {
            ...
            (n = i.items
              ? i.items[s]
              : ((n = t), i.delegate && (n = n.find(i.delegate)), n.eq(s))),
        ...
        getInline: function (e, t) {
          if ((A(), e.src)) {
            ...
            if (i.length) {
              ...
              s &&
                s.tagName &&
                (E || ((T = n.hiddenClass), (E = b(T)), (T = 'mfp-' + T)),
    ...
    u.magnificPopup.registerModule(I, {
      ...
      proto: {
        ...
        getAjax: function (s) {
          x && u(document.body).addClass(x), d.updateStatus('loading');
          var e = u.extend(
            {
              url: s.src,
              ...
              error: function () {
                $(),
                  ...
                  d.updateStatus(
                    'error',
                    d.st.ajax.tError.replace('%url%', s.src)
                  );
              },
            },
            d.st.ajax.settings
        ...
        initZoom: function () {
          ...
          if (o.enabled && d.supportsTransition) {
            ...
            _('BuildControls' + t, function () {
              ...
              _(c + t, function () {
                if (d._allowZoom()) {
                  if ((clearTimeout(n), (d.st.removalDelay = s), !e)) {
    ...
    (h.version = 'master'),
      ...
      (h._apply = function (e, t) {
        ...
        return (
          ...
          h._maintainScroll &&
            l(window).scrollTop((s / r) * l('html').outerHeight(!0)),
          this
        );
      }),
      ...
      (c.prototype.onDragEnd = function (e) {
        ...
        l(s).off('.owl.core'),
          ...
          ((0 !== t.x && this.is('dragging')) || !this.is('valid')) &&
            ...
            this.current(
              this.closest(n.x, 0 !== t.x ? i : this._drag.direction)
            ),
            this.invalidate('position'),
            this.update(),
        ...
        return (
          ...
          this.settings.loop ||
            (this.op(n, '>', r[this.minimum()])
              ? (s = n = this.minimum())
              : this.op(n, '<', r[this.maximum()]) && (s = n = this.maximum())),
          s
        );
      }),
  ...
  (function (u, e, t, n) {
    ...
    (i.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
      ...
      (i.prototype.thumbnail = function (t, e) {
        ...
        if (
          (t.wrap(u('<div/>', { class: 'owl-video-wrapper', style: s })),
  ...
  (function (i, s, e, t) {
        ...
        (this._handlers = {
          'initialized.owl.carousel': i.proxy(function (e) {
            e.namespace &&
              ...
              i(s).trigger('hashchange.owl.navigation');
          }, this),
    ...
    (n.Defaults = { URLhashListener: !1 }),
      (n.prototype.destroy = function () {
        var e, t;
        for (e in (i(s).off('hashchange.owl.navigation'), this._handlers))
          this._core.$element.off(e, this._handlers[e]);
        for (t in Object.getOwnPropertyNames(this))
          'function' != typeof this[t] && (this[t] = null);
      }),
  ...
  'object' == typeof navigator &&
    (function (e, t) {
        ...
        Array.from(t)
          ...
          .forEach(function (e, t) {
            var n = 0 < t ? o.cloneNode(!0) : o,
              i = e.parentNode,
              s = e.nextSibling;
            n.appendChild(e), s ? i.insertBefore(n, s) : i.appendChild(n);
          });
      }
      function C(s, e) {
        g.element(s) &&
      ...
      function T(e, t, n) {
        ...
        return g.object(t) && C(i, t), g.string(n) && (i.innerText = n), i;
      }
      function E(e, t, n, i) {
        g.element(t) && t.appendChild(T(e, n, i));
      }
      function k(e) {
        g.nodeList(e) || g.array(e)
          ? Array.from(e).forEach(k)
          : g.element(e) &&
            g.element(e.parentNode) &&
      ...
      function A(e, t) {
        return g.element(t) && g.element(t.parentNode) && g.element(e)
      ...
      var z,
        ...
        U = {
          ...
          pip: !(
            F.isIPhone ||
            (!g.function(T('video').webkitSetPresentationMode) &&
                ...
                set: function (t) {
                  ...
                  if (e) {
                    ...
                    (a.media.src = e.getAttribute('src')),
                      ('none' !== o || r) &&
                        (a.once('loadedmetadata', function () {
                          (a.currentTime = i), s || a.play();
                        }),
                        a.media.load()),
      ...
      function Q() {
        ...
        return g.object(s)
          ? (Object.keys(s).forEach(function (e) {
              g.object(s[e])
                ? (Object.keys(t).includes(e) || Object.assign(t, o({}, e, {})),
                  Q(t[e], s[e]))
                : Object.assign(t, o({}, e, s[e]));
            }),
            Q.apply(void 0, [t].concat(n)))
          : t;
      }
      function Y(e) {
        for (
      ...
      var ee = {
        ...
        te = function () {
          ...
          var s = K(t.i18n, e);
          if (g.empty(s)) return Object.keys(ee).includes(e) ? ee[e] : '';
      ...
      function se(e, t) {
        if (g.string(e)) {
          ...
          if (!n || !i()) {
            ...
            if (
              (r.setAttribute('hidden', ''), n && r.setAttribute('id', t), o)
            ) {
      ...
      function le() {
        var e =
          ...
          t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
          n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2];
        if (!g.number(e)) return le(null, t, n);
        var i = function (e) {
      ...
      var ce = {
        ...
        findElements: function () {
          try {
            return (
              ...
              g.element(this.elements.progress) &&
        ...
        createIcon: function (e, t) {
          ...
          C(o, Q(t, { role: 'presentation', focusable: 'false' }));
        ...
        createBadge: function (e) {
          ...
          var t = T('span', { class: this.config.classNames.menu.value });
          return (
            t.appendChild(
        ...
        createButton: function (e, t) {
          ...
          return (
            s.toggle
              ? (o.appendChild(
                  ce.createIcon.call(this, s.iconPressed, {
                    class: 'icon--pressed',
                  })
                ),
                o.appendChild(
                  ce.createIcon.call(this, s.icon, {
                    class: 'icon--not-pressed',
                  })
                ),
                o.appendChild(
                  ce.createLabel.call(this, s.labelPressed, {
                    class: 'label--pressed',
                  })
                ),
                o.appendChild(
                  ce.createLabel.call(this, s.label, {
            ...
            C(o, n),
            'play' === i
              ? (g.array(this.elements.buttons[i]) ||
                  (this.elements.buttons[i] = []),
                this.elements.buttons[i].push(o))
              : (this.elements.buttons[i] = o),
            o
          );
        },
        createRange: function (e, t) {
          var n = T(
            'input',
            Q(
              x(this.config.selectors.inputs[e]),
              {
                type: 'range',
                min: 0,
                max: 100,
        ...
        createProgress: function (e, t) {
          var n = T(
            'progress',
            Q(
              x(this.config.selectors.display[e]),
              {
                min: 0,
                max: 100,
                value: 0,
                  ...
                  32 !== e.which &&
                    (40 === e.which || (n && 39 === e.which)
                      ? ((t = i.nextElementSibling),
                        g.element(t) || (t = i.parentNode.firstElementChild))
        ...
        updateVolume: function () {
          this.supported.ui &&
            (g.element(this.elements.inputs.volume) &&
              ce.setRange.call(
                this,
                this.elements.inputs.volume,
                this.muted ? 0 : this.volume
              ),
            g.element(this.elements.buttons.mute) &&
        ...
        setRange: function (e) {
          ...
          g.element(e) && ((e.value = t), ce.updateRangeFill.call(this, e));
        },
              ...
              switch (e.type) {
                ...
                case 'seeked':
                  (t = this.currentTime),
                    (n = this.duration),
                    (i =
                      0 === t || 0 === n || Number.isNaN(t) || Number.isNaN(n)
                        ? 0
                        : ((t / n) * 100).toFixed(2)),
                    'timeupdate' === e.type &&
                      ce.setRange.call(this, this.elements.inputs.seek, i);
                  break;
                case 'playing':
                case 'progress':
                  !(function (e, t) {
        ...
        updateRangeFill: function (e) {
          ...
          if (g.element(t) && 'range' === t.getAttribute('type')) {
            if (O(t, this.config.selectors.inputs.seek)) {
              ...
              t.setAttribute(
                'aria-valuetext',
                s.replace('{currentTime}', n).replace('{duration}', i)
              );
        ...
        updateSeekTooltip: function (e) {
          ...
          if (
            ...
            g.element(this.elements.inputs.seek) &&
            g.element(this.elements.display.seekTooltip) &&
            0 !== this.duration
          ) {
            var n = 0,
            ...
            if (this.touch) o(!1);
              ...
              if (g.event(e)) n = (100 / i.width) * (e.pageX - i.left);
                ...
                if (!D(this.elements.display.seekTooltip, s)) return;
                n = parseFloat(
        ...
        timeUpdate: function (e) {
          var t =
            !g.element(this.elements.display.duration) &&
        ...
        updateSetting: function (e, t, n) {
          ...
          if (
            (g.element(o) || (o = i && i.querySelector('[role="menu"]')),
            g.element(o))
          ) {
            this.elements.settings.buttons[e].querySelector(
              '.'.concat(this.config.classNames.menu.value)
            ).innerHTML = ce.getLabel.call(this, e, s);
        ...
        setQualityMenu: function (e) {
          ...
          if (g.element(this.elements.settings.panels.quality)) {
            var s = 'quality',
              o = this.elements.settings.panels.quality.querySelector(
                '[role="menu"]'
              );
            g.array(e) &&
              (this.options.quality = V(e).filter(function (e) {
                return i.config.quality.options.includes(e);
              }));
            var t =
              !g.empty(this.options.quality) && 1 < this.options.quality.length;
            if (
              (ce.toggleMenuButton.call(this, s, t),
              S(o),
        ...
        setCaptionsMenu: function () {
          ...
          if (g.element(this.elements.settings.panels.captions)) {
            var e = 'captions',
              ...
              s = Boolean(t.length);
            if (
              (ce.toggleMenuButton.call(this, e, s),
              S(i),
              ce.checkMenu.call(this),
              s)
            ) {
              var o = t.map(function (e, t) {
                return {
                  ...
                  badge:
                    e.language &&
                    ce.createBadge.call(n, e.language.toUpperCase()),
                  list: i,
                  type: 'language',
                };
              });
        ...
        setSpeedMenu: function (e) {
          ...
          if (g.element(this.elements.settings.panels.speed)) {
            var n = 'speed',
              i = this.elements.settings.panels.speed.querySelector(
                '[role="menu"]'
              );
            g.array(e)
            ...
            var s =
              !g.empty(this.options.speed) && 1 < this.options.speed.length;
        ...
        toggleMenu: function (e) {
          ...
          if (g.element(t) && g.element(n)) {
            var i = t.hidden,
              s = i;
            if (g.boolean(e)) s = e;
            else if (g.keyboardEvent(e) && 27 === e.which) s = !1;
            else if (g.event(e)) {
              var o = t.contains(e.target);
              if (o || (!o && e.target !== n && s)) return;
            }
            n.setAttribute('aria-expanded', s),
              ...
              s && g.keyboardEvent(e)
                ...
                : s || i || M.call(this, n, g.keyboardEvent(e));
          }
        },
        ...
        showMenuPanel: function () {
          ...
          if (g.element(i)) {
            ...
            I(o, !0), I(i, !1), ce.focusFirstMenuItem.call(this, i, t);
          }
        },
        ...
        create: function (r) {
          ...
          if (
            (this.config.controls.includes('restart') &&
              e.appendChild(ce.createButton.call(this, 'restart')),
            this.config.controls.includes('rewind') &&
              e.appendChild(ce.createButton.call(this, 'rewind')),
            this.config.controls.includes('play') &&
              e.appendChild(ce.createButton.call(this, 'play')),
            this.config.controls.includes('fast-forward') &&
              e.appendChild(ce.createButton.call(this, 'fast-forward')),
          ...
          if (
            (this.config.controls.includes('current-time') &&
              e.appendChild(ce.createTime.call(this, 'currentTime')),
            this.config.controls.includes('duration') &&
              e.appendChild(ce.createTime.call(this, 'duration')),
            this.config.controls.includes('mute') ||
              this.config.controls.includes('volume'))
          ) {
            var i = T('div', { class: 'plyr__volume' });
            if (
              (this.config.controls.includes('mute') &&
                i.appendChild(ce.createButton.call(this, 'mute')),
              this.config.controls.includes('volume'))
            ) {
              var s = { max: 1, step: 0.05, value: this.config.volume };
              i.appendChild(
                ce.createRange.call(
                  this,
                  'volume',
                  Q(s, { id: 'plyr-volume-'.concat(r.id) })
                )
              ),
          ...
          if (
            (this.config.controls.includes('captions') &&
              e.appendChild(ce.createButton.call(this, 'captions')),
            this.config.controls.includes('settings') &&
              !g.empty(this.config.settings))
          ) {
            var o = T('div', { class: 'plyr__menu', hidden: '' });
            o.appendChild(
            ...
            var l = T('div', {
              ...
              c = T('div'),
              u = T('div', { id: 'plyr-settings-'.concat(r.id, '-home') }),
              d = T('div', { role: 'menu' });
            u.appendChild(d),
              c.appendChild(u),
              ...
              this.config.settings.forEach(function (e) {
                var t = T(
                  'button',
                  Q(x(a.config.selectors.buttons.settings), {
                    type: 'button',
                    class: ''
                      .concat(a.config.classNames.control, ' ')
                      .concat(a.config.classNames.control, '--forward'),
                    role: 'menuitem',
                    'aria-haspopup': !0,
                    hidden: '',
                  })
                ...
                var n = T('span', null, te(e, a.config)),
                  i = T('span', { class: a.config.classNames.menu.value });
                (i.innerHTML = r[e]),
                  n.appendChild(i),
                  t.appendChild(n),
                  d.appendChild(t);
                var s = T('div', {
                  ...
                  o = T('button', {
                    ...
                    class: ''
                      .concat(a.config.classNames.control, ' ')
                      .concat(a.config.classNames.control, '--back'),
                  });
                o.appendChild(
                  T('span', { 'aria-hidden': !0 }, te(e, a.config))
                ),
                  o.appendChild(
                    T(
                      'span',
          ...
          if (
            (this.config.controls.includes('pip') &&
              U.pip &&
              e.appendChild(ce.createButton.call(this, 'pip')),
            this.config.controls.includes('airplay') &&
              U.airplay &&
              e.appendChild(ce.createButton.call(this, 'airplay')),
          ...
          return (
            this.config.controls.includes('fullscreen') &&
              e.appendChild(ce.createButton.call(this, 'fullscreen')),
        ...
        inject: function () {
          ...
          var n = {
            ...
            s = !0;
          g.function(this.config.controls) &&
            (this.config.controls = this.config.controls.call(this.props)),
            this.config.controls || (this.config.controls = []),
            g.element(this.config.controls) || g.string(this.config.controls)
              ? (t = this.config.controls)
              : ((t = ce.create.call(this, {
                  id: this.id,
                  seektime: this.config.seekTime,
                  speed: this.speed,
          ...
          if (
            (s &&
              (g.string(this.config.controls)
                ? (t = r(t))
                : g.element(t) && (t.innerHTML = r(t.innerHTML))),
            g.string(this.config.selectors.controls.container) &&
              (o = document.querySelector(
                this.config.selectors.controls.container
              )),
            g.element(o) || (o = this.elements.container),
            o[g.element(t) ? 'insertAdjacentElement' : 'insertAdjacentHTML'](
              'afterbegin',
              t
            ),
            ...
            Object.values(this.elements.buttons)
              .filter(Boolean)
              .forEach(function (e) {
                g.array(e) || g.nodeList(e)
                  ? Array.from(e).filter(Boolean).forEach(a)
                  : a(e);
              });
          }
          if (
            (window.navigator.userAgent.includes('Edge') && R(o),
      ...
      var he = {
          setup: function () {
            if (this.supported.ui)
              if (
                !this.isVideo ||
                this.isYouTube ||
                (this.isHTML5 && !U.textTracks)
              )
                g.array(this.config.controls) &&
                  this.config.controls.includes('settings') &&
                ...
                var e, t;
                if (
                  (g.element(this.elements.captions) ||
                    ((this.elements.captions = T(
                      'div',
                      x(this.config.selectors.captions)
                    )),
                ...
                if (
                  (g.boolean(o) || (o = this.config.captions.active),
          ...
          update: function () {
            ...
            this.isHTML5 &&
              ...
              ((a && this.language !== s) || !e.includes(r)) &&
                (he.setLanguage.call(this, s), he.toggle.call(this, i && a)),
              $(
      ...
      function Ce() {
        ...
        if (
          ...
          t
            ? ((this.cleanupViewport = !s), s || (n.content += ','.concat(i)))
        ...
        function n(e) {
          ...
          u(this, n),
            ...
            v.call(
              ...
              'dblclick',
              function (e) {
                (g.element(t.player.elements.controls) &&
                  t.player.elements.controls.contains(e.target)) ||
                  t.toggle();
              }
            ),
            this.update();
          ...
          e(
            ...
            [
              ...
              },
              {
                ...
                get: function () {
                  return (
                    (n.native || this.player.config.fullscreen.fallback) &&
                  ...
                  return (
                    ['webkit', 'moz', 'ms'].some(function (e) {
                      return (
                        !(
                          !g.function(
                            document[''.concat(e, 'ExitFullscreen')]
                          ) &&
                          !g.function(
      ...
      function Ee(s) {
        ...
        return new Promise(function (e, t) {
          ...
          Object.assign(n, { onload: i, onerror: i, src: s });
        });
      }
      var ke = {
          ...
          build: function () {
            ...
            g.element(this.elements.controls) ||
              ...
              $(
                ...
                U.pip && this.isHTML5 && this.isVideo
              ),
              $(
                this.elements.container,
                this.config.classNames.airplay.supported,
                U.airplay && this.isHTML5
              ),
              ...
              this.poster &&
                ke.setPoster.call(this, this.poster, !1).catch(function () {}),
              this.config.duration && ce.durationUpdate.call(this);
          },
          setTitle: function () {
            var t = te('play', this.config);
            if (
              (g.string(this.config.title) &&
                !g.empty(this.config.title) &&
          ...
          setPoster: function (t) {
            ...
            return (1 < arguments.length &&
              ...
              !arguments[1]) ||
              !this.poster
              ? (this.media.setAttribute('poster', t),
                function () {
                  var t = this;
                  return new Promise(function (e) {
                    return t.ready
                      ? setTimeout(e, 0)
                      : v.call(t, t.elements.container, 'ready', e);
                  }).then(function () {});
                }
                  .call(this)
                  .then(function () {
                  ...
                  .catch(function (e) {
                    throw (t === n.poster && ke.togglePoster.call(n, !1), e);
                  })
                  .then(function () {
                    if (t !== n.poster)
                      throw new Error(
          ...
          checkPlaying: function (e) {
            ...
            $(
              ...
              (g.event(e) && 'timeupdate' === e.type) ||
                ke.toggleControls.call(this);
          },
                  ...
                  if (
                    ...
                    if (s) {
                      ...
                      if (g.element(r)) {
                        ...
                        if (r !== n.inputs.seek && O(r, a)) return;
                        if (
                          32 === e.which &&
                          O(r, 'button, [role^="menuitem"]')
                        )
                          return;
                      }
                      switch (
              ...
              },
              {
                ...
                value: function () {
                  ...
                  t.config.keyboard.global &&
                    f.call(t, window, 'keydown keyup', this.handleKey, e, !1),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  !i.config.keyboard.global &&
                    i.config.keyboard.focused &&
                    v.call(i, s.container, 'keydown keyup', this.handleKey, !1),
                    v.call(
                      i,
                      s.container,
                ...
                value: function () {
                  ...
                  if (
                    ...
                    v.call(i, i.media, 'canplay loadeddata', function () {
                      I(s.volume, !i.hasAudio), I(s.buttons.mute, !i.hasAudio);
                    }),
                    ...
                    v.call(i, s.container, 'click', function (e) {
                      ([s.container, t].includes(e.target) ||
                        ...
                        ((i.touch && i.config.hideControls) ||
                          (i.ended ? (i.restart(), i.play()) : i.togglePlay()));
                    });
                  }
                  i.supported.ui &&
                ...
                value: function () {
                  ...
                  if (
                    ...
                    this.bind(i.buttons.settings, 'click', function (e) {
                      e.stopPropagation(), ce.toggleMenu.call(a, e);
                    }),
                    this.bind(
                      i.buttons.settings,
                      'keyup',
                      function (e) {
                        ...
                        [13, 32].includes(t) &&
                          (13 !== t
                            ...
                            : ce.focusFirstMenuItem.call(a, null, !0));
                      },
                      null,
                      !1
                    ),
                    ...
                    this.bind(
                      ...
                      function (e) {
                        ...
                        if (!g.keyboardEvent(e) || 39 === n || 37 === n) {
                          ...
                          s && o
                            ? (t.removeAttribute(i), a.play())
                            : !o &&
                              a.playing &&
                              (t.setAttribute(i, ''), a.pause());
                        }
                      }
                    ),
                    F.isIos)
                  ...
                  this.bind(
                    ...
                    F.isWebkit &&
                      Array.from(P.call(a, 'input[type="range"]')).forEach(
                        function (e) {
                    ...
                    a.config.toggleInvert &&
                      !g.element(i.display.duration) &&
                      this.bind(i.display.currentTime, 'click', function () {
                        0 !== a.currentTime &&
                          ((a.config.invertTime = !a.config.invertTime),
              ...
              function h(n, i, s, o) {
                ...
                (o = o || 0),
                  /(^css!|\.css$)/.test(n)
                    ...
                    ? ((a = e.createElement('img')).src = u)
                    : (((a = e.createElement('script')).src = n),
                      (a.async = void 0 === t || t)),
                  !(a.onload = a.onerror = a.onbeforeload = function (e) {
                    ...
                    if ('e' == t && (o += 1) < l) return h(n, i, s, o);
                    i(n, t, e.defaultPrevented);
                  }) !== c(n, a) && e.head.appendChild(a);
              }
              function n(e, t, n) {
                var i, s;
                if ((t && t.trim && (i = t), (s = (i ? n : t) || {}), i)) {
                  if (i in o) throw 'LoadJS';
                  o[i] = !0;
                }
                !(function (e, i, t) {
                  var n,
      ...
      var De = {
        setup: function () {
          ...
          $(this.elements.wrapper, this.config.classNames.embed, !0),
            ...
            g.object(window.Vimeo)
              ? De.ready.call(this)
              : Ie(this.config.urls.vimeo.sdk)
                  .then(function () {
                    De.ready.call(t);
                  })
                  .catch(function (e) {
        ...
        setAspectRatio: function (e) {
          var t = m(
              (g.string(e) ? e : this.config.ratio).split(':').map(Number),
              2
            ),
            n = (100 / t[0]) * t[1];
          if (
        ...
        ready: function () {
          ...
          g.empty(t) &&
            (t = r.media.getAttribute(r.config.attributes.embed.id));
          var n,
            i =
              ((n = t),
              g.empty(n)
                ...
                : g.number(Number(n))
                ? n
                : n.match(/^.*(vimeo.com\/|video\/)(\d+).*/)
                ? RegExp.$2
                : n),
            o = T('iframe'),
            a = Y(r.config.urls.vimeo.iframe, i, e);
          ...
          l.appendChild(o),
            ...
            (r.media.play = function () {
              return $e.call(r, !0), r.embed.play();
            }),
            (r.media.pause = function () {
              return $e.call(r, !1), r.embed.pause();
            }),
          ...
          Object.defineProperty(r.media, 'playbackRate', {
            ...
            set: function (e) {
              r.embed
                .setPlaybackRate(e)
                .then(function () {
                  (u = e), b.call(r, r.media, 'ratechange');
                })
                .catch(function (e) {
          ...
          Object.defineProperty(r.media, 'volume', {
            ...
            set: function (e) {
              r.embed.setVolume(e).then(function () {
                (d = e), b.call(r, r.media, 'volumechange');
              });
            },
          });
          ...
          Object.defineProperty(r.media, 'muted', {
            ...
            set: function (e) {
              ...
              r.embed.setVolume(t ? 0 : r.config.volume).then(function () {
                (h = t), b.call(r, r.media, 'volumechange');
              });
            },
          });
          var p,
          ...
          Object.defineProperty(r.media, 'loop', {
            ...
            r.embed.getVideoTitle().then(function (e) {
              (r.config.title = e), ke.setTitle.call(s);
            }),
            r.embed.getCurrentTime().then(function (e) {
              (c = e), b.call(r, r.media, 'timeupdate');
            }),
            r.embed.getDuration().then(function (e) {
              (r.media.duration = e), b.call(r, r.media, 'durationchange');
            }),
            r.embed.getTextTracks().then(function (e) {
              (r.media.textTracks = e), he.setup.call(r);
            }),
            ...
            r.embed.on('loaded', function () {
              (r.embed.getPaused().then(function (e) {
                $e.call(r, !e), e || b.call(r, r.media, 'playing');
              }),
              g.element(r.embed.element) && r.supported.ui) &&
                r.embed.element.setAttribute('tabindex', -1);
            }),
            r.embed.on('play', function () {
              $e.call(r, !0), b.call(r, r.media, 'playing');
            }),
            ...
            r.embed.on('ended', function () {
              (r.media.paused = !0), b.call(r, r.media, 'ended');
            }),
            r.embed.on('error', function (e) {
              (r.media.error = e), b.call(r, r.media, 'error');
            }),
        ...
        Ne = {
          setup: function () {
            ...
            $(this.elements.wrapper, this.config.classNames.embed, !0),
              ...
              g.object(window.YT) && g.function(window.YT.Player)
                ? Ne.ready.call(this)
                : (Ie(this.config.urls.youtube.sdk).catch(function (e) {
          ...
          getTitle: function (e) {
            ...
            if (g.function(this.embed.getVideoData)) {
              ...
              if (g.empty(n))
                return (this.config.title = n), void ke.setTitle.call(this);
            }
            var i = this.config.keys.google;
            g.string(i) &&
              !g.empty(i) &&
              ie(Y(this.config.urls.youtube.api, e, i))
                .then(function (e) {
                  g.object(e) &&
          ...
          ready: function () {
            ...
            if (g.empty(e) || !e.startsWith('youtube-')) {
              ...
              g.empty(t) &&
                (t = s.media.getAttribute(this.config.attributes.embed.id));
              var n,
                i,
                o =
                  ((n = t),
                ...
                r =
                  ((i = s.provider),
                  ''.concat(i, '-').concat(Math.floor(1e4 * Math.random()))),
                a = T('div', { id: r, poster: s.poster });
              s.media = A(a, s.media);
              var l = function (e) {
              ...
              Ee(l('maxres'), 121)
                ...
                .then(function (e) {
                  e.includes('maxres') ||
                    (s.elements.poster.style.backgroundSize = 'cover');
                })
                .catch(function () {}),
                  ...
                  events: {
                    onError: function (e) {
                      if (!s.media.error) {
                        ...
                        (s.media.error = { code: t, message: n }),
                      ...
                      if (!g.function(s.media.play)) {
                        ...
                        Ne.getTitle.call(s, o),
                          (s.media.play = function () {
                            Oe.call(s, !0), n.playVideo();
                          }),
                          (s.media.pause = function () {
                            Oe.call(s, !1), n.pauseVideo();
                          }),
                        ...
                        Object.defineProperty(s.media, 'muted', {
                          ...
                          s.supported.ui &&
                            s.media.setAttribute('tabindex', -1),
                    ...
                    onStateChange: function (e) {
                      var t = e.target;
                      switch (
                        (clearInterval(s.timers.playing),
                        s.media.seeking &&
                          [1, 2].includes(e.data) &&
                          ((s.media.seeking = !1),
                        ...
                        case 0:
                          Oe.call(s, !1),
                            s.media.loop
                              ...
                              : b.call(s, s.media, 'ended');
                          break;
                        case 1:
                          s.media.paused && !s.embed.hasPlayed
                            ? s.media.pause()
                            : (Oe.call(s, !0),
                              ...
                              s.media.duration !== t.getDuration() &&
                                ((s.media.duration = t.getDuration()),
                                b.call(s, s.media, 'durationchange')));
                          break;
                        case 2:
                          s.muted || s.embed.unMute(), Oe.call(s, !1);
                      }
            ...
            this.media
              ? ($(
                ...
                this.isHTML5
                  ...
                  : this.isYouTube
                  ? Ne.setup.call(this)
                  : this.isVimeo && De.setup.call(this))
            ...
            e(t, [
              {
                ...
                value: function () {
                  var e = this;
                  this.enabled &&
                    (g.object(window.google) && g.object(window.google.ima)
                      ? this.ready()
                ...
                value: function () {
                  ...
                  this.countdownTimer = setInterval(function () {
                    var e = le(Math.max(n.manager.getRemainingTime(), 0)),
                      t = ''
                        .concat(te('advertisement', n.player.config), ' - ')
                        .concat(e);
                ...
                value: function () {
                  ...
                  this.player.on('ended', function () {
                    ...
                    this.player.on('seeked', function () {
                      ...
                      g.empty(s.cuePoints) ||
                        s.cuePoints.forEach(function (e, t) {
                          i < e &&
                            e < n &&
                            (s.manager.discardAdBreak(),
              ...
              },
              {
                ...
                value: function (e, t) {
                  return (
                    g.array(this.events[e]) || (this.events[e] = []),
              ...
              },
              {
                ...
                value: function (e) {
                  g.nullOrUndefined(this.safetyTimer) ||
                    (this.player.debug.log(
                ...
                this.destroy.call(
                  ...
                  function () {
                    (c.options.quality = []),
                      k(c.media),
                      (c.media = null),
                      g.element(c.elements.container) &&
                        c.elements.container.removeAttribute('class');
                    var e = l.sources,
                      t = l.type,
                      n = m(e, 1)[0],
                      i = n.provider,
                    ...
                    Object.assign(c, {
                      ...
                      c.isHTML5 &&
                        (c.config.crossorigin &&
                          c.media.setAttribute('crossorigin', ''),
                        c.config.autoplay &&
                          c.media.setAttribute('autoplay', ''),
                        g.empty(l.poster) || (c.poster = l.poster),
                        c.config.loop.active &&
                          c.media.setAttribute('loop', ''),
                        c.config.muted && c.media.setAttribute('muted', ''),
                        c.config.playsinline &&
                          c.media.setAttribute('playsinline', '')),
                      ke.addStyleHook.call(c),
                      c.isHTML5 && je.insertElements.call(c, 'source', e),
                      (c.config.title = l.title),
                      Me.setup.call(c),
                      c.isHTML5 &&
                        Object.keys(l).includes('tracks') &&
                        je.insertElements.call(c, 'track', l.tracks),
                      (c.isHTML5 || (c.isEmbed && !c.supported.ui)) &&
                        ke.build.call(c),
            ...
            if (
              ...
              if (this.media.plyr) this.debug.warn('Target already setup');
                ...
                if (U.check().api) {
                  ...
                  var s,
                    o = this.media.tagName.toLowerCase(),
                    r = null,
                    a = null;
                  switch (o) {
                    case 'div':
                      if (
                        ((r = this.media.querySelector('iframe')), g.element(r))
                      ) {
                        if (
                          ((a = ue(r.getAttribute('src'))),
                          (this.provider =
                            ((s = a.toString()),
                          ...
                          l.includes(a.searchParams.get('autoplay')) &&
                            ...
                            this.isYouTube
                              ? ((this.config.playsinline = l.includes(
                                ...
                                (this.config.hl = a.searchParams.get('hl')))
                  ...
                  (this.supported = U.check(
                    ...
                    this.supported.api
                      ? ((this.eventListeners = []),
                        ...
                        g.element(this.elements.container) ||
                          ((this.elements.container = T('div')),
              ...
              [
                {
                  key: 'play',
                  value: function () {
                    return g.function(this.media.play)
                      ? this.media.play()
                      : null;
                  },
                },
                ...
                },
                {
                  ...
                  value: function () {
                    this.isHTML5
                      ...
                      : g.function(this.media.stop) && this.media.stop();
                  },
                },
                {
                  key: 'restart',
                ...
                },
                {
                  ...
                  value: function (e) {
                    this.currentTime =
                      this.currentTime -
                      (g.number(e) ? e : this.config.seekTime);
                  },
                },
                {
                  key: 'forward',
                ...
                },
                {
                  ...
                  set: function (e) {
                    this.isVideo
                      ? ke.setPoster.call(this, e, !1).catch(function () {})
                ...
                },
                {
                  ...
                  set: function (e) {
                    if (U.pip) {
                      ...
                      g.function(this.media.webkitSetPresentationMode) &&
                        this.media.webkitSetPresentationMode(t ? fe : me),
                        g.function(this.media.requestPictureInPicture) &&
                          (!this.pip && t
                  ...
                  get: function () {
                    return U.pip
                      ? g.empty(this.media.webkitPresentationMode)
                        ? this.media === document.pictureInPictureElement
                        : this.media.webkitPresentationMode === fe
                      : null;
                  },
                },
              ],
                  ...
                  value: function (e) {
                    ...
                    return (
                      g.string(e)
                        ...
                        : g.nodeList(e)
                        ? (n = Array.from(e))
                        : g.array(e) && (n = e.filter(g.element)),
                      g.empty(n)
                        ? null
                        : n.map(function (e) {
                            return new c(e, t);
      ...
      return (qe.defaults = ((Pe = pe), JSON.parse(JSON.stringify(Pe)))), qe;
    }),
  (function () {
    ...
    function a(e, t) {
      if (((this.path = e || ''), null != t))
        ...
        if (void 0 !== document.createElement) {
          ...
          (i[0] = i[0].replace(o, r)), (this.at_2x_path = i.join('?'));
        }
    ...
    ((t.RetinaImagePath = a).confirmed_paths = []),
      ...
      (a.prototype.check_2x_variant = function (t) {
        ...
        return this.is_external()
          ...
          ? this.at_2x_path in a.confirmed_paths
            ? t(!0)
            : ((n = new XMLHttpRequest()).open('HEAD', this.at_2x_path),
              (n.onreadystatechange = function () {
                ...
                if (200 <= n.status && n.status <= 399) {
                  ...
                  return a.confirmed_paths.push(i.at_2x_path), t(!0);
                }
                return t(!1);
              }),
              void n.send())
          ...
          (e && e.requirejs) ||
            ...
            (function (p) {
              ...
              function E(e) {
                if (w(v, e)) {
                  var t = v[e];
                  delete v[e], (_[e] = !0), o.apply(p, t);
                }
                if (!w(g, e) && !w(_, e)) throw new Error('No ' + e);
                return g[e];
              }
              function l(e) {
                var t,
                  ...
                  if (
                    ...
                    for (
                      ...
                      if ('require' === (o = (a = f(t[l], c)).f))
                        d[l] = m.require(e);
                      else if ('exports' === o) (d[l] = m.exports(e)), (u = !0);
                      else if ('module' === o) s = d[l] = m.module(e);
                      else if (w(g, o) || w(v, o) || w(_, o)) d[l] = E(o);
                      else {
                        if (!a.p) throw new Error(e + ' missing ' + o);
                        a.p.load(a.n, C(i, !0), T(o), {}), (d[l] = g[o]);
                      }
                    (r = n ? n.apply(g[e], d) : void 0),
                      e &&
                        (s && s.exports !== p && s.exports !== g[e]
                          ? (g[e] = s.exports)
                          : (r === p && u) || (g[e] = r));
                  } else e && (g[e] = n);
                }),
            ...
            function (e, a, l) {
              ...
              return (
                ...
                (n.prototype.select = function (s) {
                  var o = this;
                  if (((s.selected = !0), l(s.element).is('option')))
                    return (
                ...
                (n.prototype.unselect = function (s) {
                  var o = this;
                  if (this.$element.prop('multiple')) {
                    if (((s.selected = !1), l(s.element).is('option')))
                      return (
                ...
                (n.prototype.apply = function (e) {
                  if (
                    ...
                    if (
                      ...
                      0 < e.minimumInputLength &&
                        (e.dataAdapter = y.Decorate(e.dataAdapter, E)),
                      0 < e.maximumInputLength &&
                        (e.dataAdapter = y.Decorate(e.dataAdapter, k)),
                  ...
                  if (
                    (null == e.resultsAdapter &&
                      ((e.resultsAdapter = d),
                      null != e.ajax &&
                        (e.resultsAdapter = y.Decorate(e.resultsAdapter, $)),
                      null != e.placeholder &&
                        (e.resultsAdapter = y.Decorate(e.resultsAdapter, I)),
                      e.selectOnClose &&
                        (e.resultsAdapter = y.Decorate(e.resultsAdapter, P))),
                    ...
                    if (
                      ...
                      e.closeOnSelect &&
                        (e.dropdownAdapter = y.Decorate(e.dropdownAdapter, N)),
                  ...
                  this.defaults = {
                    ...
                    matcher: function e(t, n) {
                      ...
                      if (n.children && 0 < n.children.length) {
                        for (
                          var i = c.extend(!0, {}, n),
                            s = n.children.length - 1;
                          0 <= s;
                          s--
                        )
                          null == e(t, n.children[s]) &&
            ...
            function (i, u, s, d) {
              function e(e, t) {
                if (
                  ...
                  null != t &&
                    (this.options = s.applyFromElement(this.options, t)),
              ...
              return (
                (e.prototype.fromElement = function (e) {
                  ...
                  u.fn.jquery &&
                    '1.' == u.fn.jquery.substr(0, 2) &&
                    e[0].dataset &&
                    (n = u.extend(!0, {}, e[0].dataset, n));
                  var l = u.extend(!0, {}, d.GetData(e[0]), n);
                  for (var c in (l = d._convertData(l)))
                    -1 < u.inArray(c, t) ||
                      (u.isPlainObject(this.options[c])
                        ? u.extend(this.options[c], l[c])
                        : (this.options[c] = l[c]));
                  return this;
                }),
